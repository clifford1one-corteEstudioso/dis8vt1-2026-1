...
"Seguimiento Primera Sesión – Instrucciones y Material de Apoyo
Estimadas y estimados:

Junto con agradecer su participación en nuestra primera sesión, les comparto las instrucciones para el encargo acordado:

1. El Encargo:

    Presentación: Deberán exponer el tema general y un apartado específico por integrante.

    Tiempos: 6 minutos para la presentación general y 3 minutos adicionales por cada línea de investigación individual.

    Subida de archivos: [Aquí](https://drive.google.com/drive/folders/1jIyJ9kZFrPwYgnfj8zL6q292JE66V1du?usp=sharing)

2. Material de Apoyo y Referencias:
    ...
    Recursos de clase: [Se adjunta el PPT de hoy, el cual incluye las herramientas de análisis discutidas.](https://docs.google.com/presentation/d/1nPmUhNx0YgAZG8wKZhWkEqj7o4BfviAvEClueHL8Vhc/edit?slide=id.g3334a3e174c_1_0#slide=id.g3334a3e174c_1_0)

Quedamos atentos a sus dudas por discord para temas varios y por correo para temas más transversales.

<sergio.majluf@mail.udp.cl> & <manuel.gallardo@udp.cl>

Saludos y agradecidos!"

## investigación

Esta es una inevstigación que realicé el semestre pasado para postular a [Primavera hacker](https://phacker.org/) 2025
